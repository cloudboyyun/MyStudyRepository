<template>
	<view class='page'>
		...
		<movable-area class='movable-area'>
			<movable-view direction="horizontal" out-of-bounds="false" class="movable-view"
				:x="22.5" :y="0" @change="onMoved">
				<view class='calendar'>
					...
					<view class='row'>
						<view v-for="(item,index) in result.dates" :key="index" class='day'
							:class="{selected: item.date == selectedDate}" @click='onDateClick(item)'>
