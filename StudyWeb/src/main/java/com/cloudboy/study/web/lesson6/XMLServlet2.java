...
@WebServlet(name = "XMLServlet2", urlPatterns = { "/XMLServlet2" }, asyncSupported = true)
public class XMLServlet2 extends HttpServlet {
	
	private static final long serialVersionUID = -7408673724234057039L;
	private static Logger logger = Logger.getLogger(XMLServlet2.class);

	private XMLRequestHandler2 xmlRequestHandler;
	...
	public class Executor implements Runnable {
		...
		public void run() {
			if (xmlRequestHandler == null) {
				xmlRequestHandler = new XMLRequestHandler2();
			}
